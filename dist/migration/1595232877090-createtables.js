...
exports.createtables1595232877090 = void 0;

class createtables1595232877090 {
  async up(queryRunner) {
    ...
    await queryRunner.query(`CREATE TABLE "categorias_home" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(),
        "caminho" character varying(100) NOT NULL,
        CONSTRAINT "PK_239512aefbb11a5b2fa92696828" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "instagram" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(),
          "caminho" character varying(100) NOT NULL,
          CONSTRAINT "PK_239512aefbb11a5b2fa92696828" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "carrinho" ("clienteId" uuid NOT NULL, "produtoId" uuid NOT NULL, CONSTRAINT "PK_3ef0759852caaefb9bac7cf913e" PRIMARY KEY ("clienteId", "produtoId"))`);
    await queryRunner.query(`ALTER TABLE "carrinho" ADD CONSTRAINT "FK_ccb4ae4609bfbf4d022560a3f8c" FOREIGN KEY ("clienteId") REFERENCES "cliente"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "carrinho" ADD CONSTRAINT "FK_9a616bdfff1c46bddeb8ad78dbf" FOREIGN KEY ("produtoId") REFERENCES "produto"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
  }
...
exports.createtables1595232877090 = createtables1595232877090;