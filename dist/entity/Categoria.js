...
let Categoria = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("uuid"), _dec3 = (0, _typeorm.Column)("varchar"), _dec4 = (0, _typeorm.OneToMany)(type => _Produto.Produto, produto => produto.categoria), _dec5 = (0, _typeorm.CreateDateColumn)({
  name: 'created_At'
