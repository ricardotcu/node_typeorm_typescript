...
let Class = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("uuid"), _dec3 = (0, _typeorm.Column)("varchar"), _dec4 = (0, _typeorm.Column)("boolean", {
  default: false,
  nullable: true
}), _dec(_class = (_class2 = (_temp = class Class {
  constructor() {
