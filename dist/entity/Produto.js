...
let Produto = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("uuid"), _dec3 = (0, _typeorm.Column)("varchar"), _dec4 = (0, _typeorm.Column)("varchar"), _dec5 = (0, _typeorm.Column)("integer"), _dec6 = (0, _typeorm.Column)("varchar"), _dec7 = (0, _typeorm.Column)("varchar", {
  nullable: true
}), _dec8 = (0, _typeorm.ManyToOne)(type => _Categoria.Categoria, Categoria => Categoria.produtos), _dec(_class = (_class2 = (_temp = class Produto {
  constructor() {
    ...
    _initializerDefineProperty(this, "categoria", _descriptor7, this);
  }
  ...
  writable: true,
  initializer: null
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "categoria", [_dec8], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
